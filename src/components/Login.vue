...
export default {
  ...
  methods: {
      ...
      this.$refs["ruleForm"].validate((valid) => {
        ...
        if (valid) {
          if (
            ...
            this.userInfo.inputcode.toUpperCase() ===
            this.codeText.toUpperCase()
          ) {
            this.$http
              .get(
    ...
    regist() {
      if (
        this.userInfo.inputcode.toUpperCase() === this.codeText.toUpperCase()
      ) {
        this.$http({
          method: "post",
          url: "/user/add",
    ...
    randomLetter(num) {
      var arr =
        "QWERTYUIOASDFGHJKLZXCVBNMqwertyuiopasdfghjklzxcvbnm1234567890".split(
          ""
        );
      var str = "";
      for (var i = 0; i < num; i++) {
