      ...
      <el-col :span="21">
        ...
        <div v-if="count>0">
          <div v-if="showMore">
            ...
            <reCommentlist :rc="rc" :f2="f2" @post="post1" @clo="showMore=false" :admin="admin" :comment="info" :total="count"></reCommentlist>
          </div>
          <div v-else>
...
export default {
  ...
  methods:{
    ...
    getImg(photo){
      return this.$requst.commentHttp.getImage(photo)
    },
    // postre(){
